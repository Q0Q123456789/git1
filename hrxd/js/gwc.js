		...
		if(arr){
			...
			if(arr.length>0){
				...
				for(var i=0;i<arr.length;i++){
	                ...
	                $("<div class='div_a5'><span class='span_jian'>-</span><input type='text' name='' id='' value="+obj.num +" class='div_a5_txt' /><span class='span_jia'>+</span><div class='div_a5_div'>有货</div></div>").appendTo(li);
...
//  	console.log(index)
    ...
    //勾选
    $("#form_a2").on("click",".check",function(){
    	
    	var index = $(this).index("#form_a2 .check");
